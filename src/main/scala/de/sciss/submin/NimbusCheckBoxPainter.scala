...
object NimbusCheckBoxPainter extends CheckBoxPainter {
   protected def defaults : Defaults = NimbusDefaults
   ...
   protected def enabledBackColor( blueGrey: Color ) : Color =
      ColorUtil.adjustColor( blueGrey, 0.0f, 0.0f, 0.0f, -89 )

   protected def selectedCheckColor( base: Color ) : Color =
      ColorUtil.adjustColor( base, -0.57865167f, -0.6357143f, -0.54901963f, 0 )

   protected def disabledSelectedCheckColor( base: Color ) : Color =
      ColorUtil.adjustColor( base, 0.027408898f, -0.5735674f, 0.14509803f, 0 )

   protected def pressedSelectedBackColor( blueGrey: Color ) : Color =
      ColorUtil.adjustColor( blueGrey, 0.0f, -0.110526316f, 0.25490195f, -89 )
}