...
object NimbusButtonPainter extends ButtonPainter{
   protected val grad1frac = Array[ Float ]( 0.09f, 0.95f )
   ...
   protected def pressedGrad1colr( blueGrey: Color ) : Array[ Color ] = focusedPressedGrad1colr( blueGrey )
   ...
   protected def enabledBackColor( blueGrey: Color ) : Color =
      ColorUtil.adjustColor( blueGrey, -0.027777791f, -0.06885965f, -0.36862746f, -190 )

   protected def disabledBackColor( blueGrey: Color ) : Color =
      ColorUtil.adjustColor( blueGrey, -0.027777791f, -0.06885965f, -0.36862746f, -232 )
